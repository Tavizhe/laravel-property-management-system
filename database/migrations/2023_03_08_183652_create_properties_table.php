...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('properties', function (Blueprint $table) {
            ...
            $table->string('tedadTabaghe')->nullable();
            $table->string('tedadKoleTabaghat')->nullable();
            $table->string('TabagheDarVahed')->nullable();
            $table->string('VaziatBana')->nullable();
            $table->string('Jahat')->nullable();
            $table->string('nama')->nullable();
            $table->string('KafPush')->nullable();
            $table->string('ServiceKitchen')->nullable();
            $table->string('VorudiMoshtarak')->nullable();
