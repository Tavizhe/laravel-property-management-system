                                                ...
                                                <div class="price-box clearfix">
                                                    ...
                                                    <div class="price-box clearfix">
                                                        ...
                                                        <div class="price-box clearfix">
                                                            ...
                                                            <div class="author-box pull-right">
                                                                <figure class="author-thumb">
                                                                    <img src="{{ url('upload/logo/1775858854860294.png') }}"
                                                                        alt="">
                                                                    <span>Admin</span>
                                                                </figure>
                                                            </div>
                                                        ...
                                                        <ul class="more-details clearfix">
                                                            ...
                                                            <li><i class="icon-15"></i>{{ $item->bathrooms }} Baths
                                                            </li>
                        ...
                        <div class="default-sidebar agent-sidebar">
                            <div class="agents-contact sidebar-widget">
                                ...
                                <div class="form-inner">
                                    ...
                                    <form action="{{ route('agent.details.message') }}" method="post"
                                        class="default-form">
                                        @csrf
