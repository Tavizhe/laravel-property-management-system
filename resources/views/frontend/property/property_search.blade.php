                ...
                <div class="property-content-side">
                    <div class="item-shorting clearfix">
                        <div class="left-column pull-right">
                            <h5>نتیجه جستجو: <span> {{ count($property) }} مورد ملک پیدا شد!</span></h5>
                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <ul class="more-details">
                                                            ...
                                                            <li style="text-align: left">{{ $item->bathrooms }}
                                                                سرویس <i class="bi icon-15 float-end"></i></li>
                                                            <li style="text-align: left">{{ $item->property_size }}
                                                                متر <i class="bi icon-16 float-end"></i></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
...
</section> <!-- property-page-section end -->
@endsection