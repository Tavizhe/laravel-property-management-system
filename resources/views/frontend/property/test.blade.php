    ...
    <div class="auto-container">
        <div class="top-details clearfix">
            <div class="left-column pull-left clearfix">
                <div class="image-box">
                    <figure class="image card-img-top"><img src="{{ asset($property_thumbnail) }}" alt="">
                    </figure>
                                ...
                                <div class="inner">
                                    ...
                                    <div class="box clearfix">
                                        <div class="text pull-left">
                                            <h6>{{ $item->facility_name }} <span>({{ $item->distance }}
                                                    km)</span>
                                            </h6>
                                        </div>
                        ...
                        {{-- <div class="author-box">
                            ...
                            <div class="inner">
                                ...
                                <ul class="info clearfix">
                                    <li><i class="fas fa-map-marker-alt"></i>84 St. John Wood High Street,
                                        St Johns Wood</li>
                                    <li><i class="fas fa-phone"></i><a href="tel:03030571965">030 3057
                                            1965</a>
                                    </li>
                                </ul>
                            ...
                            <div class="inner">
                                ...
                                <ul class="info clearfix">
                                    ...
                                    <li><i class="fas fa-phone"></i><a href="tel:03030571965">{{
                                            $property->user->phone
                                            }}</a></li>
                                </ul>
                                @auth
                                        ...
                                        <div class="author-info clearfix">
                                            <div class="author pull-left">
                                                @if ($item->agent_id == null)
                                                    <figure class="author-thumb"><img
                                                            src="{{ url('upload/logo/1775858854860294.png') }}"
                                                            alt="">
                                                    </figure>
                                                    <h6>Admin </h6>
                                                @else
